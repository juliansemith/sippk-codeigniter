        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="btn-group float-right">
                    <a href="<?= base_url(); ?>peralatan/cetak" name="print2" class="btn float-right btn-xs btn btn-success mr-2 pl-2 pr-3"><i class="fas fa-print mr-1"></i>Print</a>
                </div>
            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="submit" id="tombolCari" name="cari1">Cari</button>
                                    <a href="<?= base_url('user/peralatan') ?>" class="btn btn-outline-danger">Reset</a>
                                </div>
                            </div>
                        </div>
                    </div>
