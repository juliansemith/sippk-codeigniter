...
<body class="A4 potrait">
    <img src="<?= base_url(); ?>public/dist/img/BPBD.png" style="position: absolute; width:75px; height:auto; margin-top:14px; margin-left: 10px;">
    ...
    <div class="ttd" style="margin-top: 20%;">
